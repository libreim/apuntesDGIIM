...
\begin{sol}
  $X^2 = I$ con $X \in M_2(\R)$.
  $X \cdot X = I \Leftrightarrow X^{-1} = X$
  $X = PJP^{-1}$
  ...
  $X = PJP^{-1}$ $X^2 = (PJP^{-1})(PJP^{-1}) = PJ^2P^{-1}$

  $X^2 = PJ^2P^{-1} = I \Rightarrow P^{-1}(PJ^{2}P^{-1})P = P^{-1}IP \Rightarrow
  J^2 = I$.

  Evaluemos ahora los casos que teníamos:
  \begin{enumerate}
  \item $J^2 =
    \begin{pmatrix}
      \lambda_1^2 & 0 \\
  ...
  \item $J =
    ...
    \begin{pmatrix}
      \lambda_1^2 & \\
      & \lambda_1^2
    \end{pmatrix} = I \Rightarrow J = I$ ó $J = -I$. Luego $X = PJP^{-1} = I$ ó
    $X = -I$.
  \item $J =
    \begin{pmatrix}
      \lambda_1 & 1 \\
...
\begin{sol}
  Decimos que una matriz $A$ es \textbf{nilpotente} si $\exists n$ tal
  que $A^n = 0$. Por ejemplo, $
  \begin{pmatrix}
    0 & 1 \\
    0 & 0
  \end{pmatrix}, A^2 = 
