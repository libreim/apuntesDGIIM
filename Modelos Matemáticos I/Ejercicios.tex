...
donde el primer par\'ametro es la funci\'on obtenida antes $(F_n)$ representada por la curva roja, el segundo par\'ametro es el punto inicial, el tercero es el n\'umero de iteraciones o valores que calculamos (n=100) y los \'ultimos par\'ametros son opciones para representar el gr\'afico.
