...
% Para una demostración más detallada de esta última afirmación, consultar [\textit{Ejercicios}, 3.4].
\end{nota}
%%% TODO: Descomentar cuando esté el ejercicio subido en el otro archivo.
