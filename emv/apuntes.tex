...
\end{nth}
\begin{ncor}
              Si $A$ es diagonalizable ortogonalmente, debe ser simétrica, pues $A^T = (QDQ^T)^T = (Q^T)^T D^T Q^T = QDQ^T = A$. El recíproco es cierto: A es diagonalizable ortogonalmente si y solo si $A$ es simétrica.
\end{ncor}
