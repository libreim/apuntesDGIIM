...
Ahora, consideramos la función $\log L(\mu,\Sigma)$:
\[
...
\begin{nprop}[Distribución de la matriz de cuasi-covarianzas muestral, \(\boldsymbol S_{\boldsymbol N \boldsymbol - \boldsymbol 1}\)]
  Sea \(S_n = \frac{A}{n}\), con \(n = N - 1\), la matrz de cuasi-covarianzas muestral que procede de la muestra aleatoria simple con población \(N_p(\boldsymbol \mu, \Sigma)\).
  Entonces, \(S_n \sim W_p(n, \frac{\Sigma}{n})\) y además, \(S_N \sim W_p(N-1, \frac{\Sigma}{N})\), con \(S_N = \frac{A}{N}\).
\end{nprop}