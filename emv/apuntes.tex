...
Aplicamos a $\vectY_1$ la \hyperref[posvar:car-i]{[C-I]}: tenemos que $\vectY_1$ puede representarse en distribución como
\[
Y_1 \eqd D^{\frac{1}{2}}Z + H_1^T \mu \quad \quad  Z \sim N_r(0,I) 
\]
