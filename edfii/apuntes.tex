...
\item Dos valores propios iguales a 0 $\lambda_1=\lambda_2=0 \Leftrightarrow \left\{ \begin{array}{rl}\Delta=0 \\ \traza(A)=0 \\ det(A)=0\end{array}$
\begin{enumerate}
\item Si $A$ es diagonalizable $A=0$
\item Si $A$ no es diagonalizable.
\end{enumerate}
\end{enumerate}
\item Caso 2: Cuando los valores propios de la matriz A no son reales : $\sigma(A)={\lambda_1,\lambda_2}\subset \C - \R \quad \lambda_1=a+bi \; \lambda_2=a-bi$
\begin{enumerate}
