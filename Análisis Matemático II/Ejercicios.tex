...
Podemos aplicar el criterio del cociente, de forma muy similar al caso anterior, para ver que el radio de convergencia de la serie es $R = \infty$. Por tanto, $D(0,R) = \mathbb{R}$, y se tiene que $\forall M \in \mathbb{R}^+$ la serie converge uniformemente en $[-M,M]$.
\end{sol}
