...
\begin{ndef}[Espacio medible]
 ...
 \begin{nlist}
	...
	\item $\mathcal{A}$ es una $\sigma-$álgebra, esto es: $\emptyset \ne A : \Omega \ A \in \mathcal{A} \ \forall A \in \mathcal{A}$ y además $\cup_{n=1}^\infty A_n \in \mathcal{A}, \forall \{A_n\} \subset \mathcal{A}$
\end{nlist}
A los elementos $A$ de $\mathcal{A}$ los llamaremos medibles.
\end{ndef}
...
\end{nota}
Ejercicio: Definición de sigma-álgebra engendrada y probar cómo se forma y propiedades.
