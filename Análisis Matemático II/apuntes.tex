...
%%% FALTA UN EJERCICIO (DIAPOSITIVAS). ¿PONER AQUÍ, O EN EJERCICIOS.TEX? --------
...
\begin{nth}[Teorema de la convergencia monótona]
  ...
  %%% ARREGLAR ESTILO Y COMPARAR CON DIAPOSITIVAS --------------------------------
  \begin{proof} Veamos las dos desigualdades.

    \boxed{\leq} Como $f_n \leq f_{n+1} \leq f$ por hipótesis, tenemos que:
    \[
      \{ s  : \begin{rcases} \text{ s simple positiva}\\ s \leq f_n 
      \end{rcases}  \subset \{ s: \begin{cases} \text{ s es simple positiva}\\
        s\leq f_{n+1}
    ...
    %%% AÑADIR EL LEMA ANTES DEL TEOREMA ---------------------------------------
...
\begin{proof}
  ...
  % Acaba de decir no se qué de una propiedad de no se qué medida que dice
