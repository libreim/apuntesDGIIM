...
\renewenvironment{proof}{{\itshape \sffamily Demostración}}{\qed}
...
Por último, como $g_k(\omega)\leq f_k(\omega) \ \forall \omega\in \Omega $ (por definición de ínfimo), aplicamos la monotonía de la integral:
\[
\int_E g_k\, d\mu  \leq \int_E f_k\, d\mu 
\overset{k\to\infty}{\implies}
\int_E \underset{n\to \infty}{\text{lim\,inf\,}} f_n\, d\mu 
\leq   \underset{k\to \infty}{\lim} \int_E f_k\, d\mu
\]
