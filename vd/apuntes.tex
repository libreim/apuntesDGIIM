...
\begin{proof}
  ...
  \end{align*}
\end{proof}
\begin{nprop}[Propiedades de la diferencial] \label{prop:propiedades-dif}
  Se verifican:
  \begin{nlist}
  \item
...
\subsection{El espacio tangente en subvariedades del euclídeo}
...
\begin{proof}
  ...
  \begin{tikzcd}
    ...
    \T_{F(p)}N \arrow{d}{\d\psi_{F(p)}} \\
    \R^{n} \arrow{r}{\d(\psi\circ F \circ\phi^{-1})}
  \end{tikzcd}
\]
