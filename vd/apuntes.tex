...
\begin{ejemplo}[Espacio proyectivo real]
  El espacio proyectivo real es un cociente
  \[
    \mathbb{RP}^{n} = \frac{\R^{n+1}-\{0\}}{\mathrm{R}}
  ,\]
...
recubren a $\mathbb{RP}^{n}$. Para construir las cartas, vamos a contruir
...
\begin{nprop}[Propiedades de las aplicaciones diferenciables]
  \hfill
  \begin{nlist}
  \item
  ...
  \item
    la composición de difeomorfismos es diferenciable,
  \item
...
\end{nprop}
\begin{proof}
  (vi): considerando en $\R^{n}$ la estructura diferenciable
