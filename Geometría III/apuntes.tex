...
\begin{proof}\hfill \\
  $\boxed{\Rightarrow}$\\
  %%%¿HARÍA FALTA EXPLICARLA MÁS? no me salio muy clara.
  ...
  $\boxed{\Leftarrow}$ \\
  Por ser los lados opuestos paralelos de la misma distancia, y la diagonal también, ambos triángulos ABC y BCD son iguales. Entonces, además sabemos que  $\angle A = \angle B = \angle C  = \angle D$. Por último, como un cuadrilatero está compuesto por dos triángulos, sabemos que sus ángulos deben sumar $2\pi$, por lo que cada ángulo debe medir $\pi/2$, por lo que todos los lados son perpeniculares.
