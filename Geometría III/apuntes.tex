...
\subsection{Cuádricas en $\R^3$}
Una cuádrica viene dada por una ecuación de la forma:
\[
\mathcal Q \equiv ax^2 + by^2 + cz^2+ dxy + exz + fyz + gx + hy+ iz + j = 0
\]
...
y\\
z\\
\end{pmatrix} + 2(g/2,h/2,i/2) \begin{pmatrix}
 x\\
 y\\
 z
\end{pmatrix}  + j
\]
La matriz $3\times 3$ será, como se puede ver, simétrica.
