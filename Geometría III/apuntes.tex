...
\begin{ndef}[Espacio afín]
  Sea $E$ un conjunto no vacío. Entonces diremos que $E$ es un espacio afín asociado a un espacio vectorial $V$ si existe una aplicación
  \begin{align*}
...
%%% TODO: ¿Insertar un dibujo con la suma de un vector a un punto?
...
\begin{proof}
  ...
  Restamos primero $P-P_1 = \sum \alpha_i(P_i-P_1)$, obteniendo así una identidad entre vectores de la forma:
  \[
