...
\sffamily
    \begin{axis}[
            ...
            view={60}{40}]
         % x^2+y^2-z^2=0
        \addplot3[mesh,500,domain=0:2,y domain=0:2*pi, samples=20]({2*cos(deg(x))*sin(deg(y))},{3*sin(deg(x))*sin(deg(y))},{2*cos(deg(y))}); 
        \addplot3[mesh,500,domain=0:2,y domain=0:2*pi, samples=20]({2*cos(deg(x))*sin(deg(y))},{-3*sin(deg(x))*sin(deg(y))},{2*cos(deg(y))});     
        %\addplot3[mesh,500,domain=0:2,y domain=0:2*pi, samples=20]({x*cos(deg(y))},{x*sin(deg(y))},{-x});   
    \end{axis}
\end{tikzpicture}
\end{minipage}
...
\sffamily
    \begin{axis}[
            ...
            view={60}{40}]
         % x^2+y^2-z^2=-1
            \addplot3[mesh,500,domain=1:2,y domain=0:2*pi,samples=15]({x*cos(deg(y))},{x*sin(deg(y))},{sqrt(x^2-1)});    
        \addplot3[mesh,500,domain=1:2,y domain=0:2*pi,samples=15]({x*cos(deg(y))},{x*sin(deg(y))},{-sqrt(x^2-1)}); 
    \end{axis}
\end{tikzpicture}
\end{minipage}
...
\sffamily
    \begin{axis}[
            ...
            view={60}{40}]
         % x^2+y^2-z^2=-1
            \addplot3[mesh,500,domain=1:2,y domain=0:2*pi,samples=15]({0.5*sinh(x)*cos(deg(y))},{0.5*sinh(x)*sin(deg(y))},{0.5*cosh(x)});
            \addplot3[mesh,500,domain=1:2,y domain=0:2*pi,samples=15]({0.5*sinh(x)*cos(deg(y))},{0.5*sinh(x)*sin(deg(y))},{-0.5*cosh(x)});    
        %\addplot3[mesh,500,domain=1:2,y domain=0:2*pi,samples=15]({x*cos(deg(y))},{x*sin(deg(y))},{-sqrt(x^2-1)}); 
    \end{axis}
\end{tikzpicture}
...
\sffamily
    \begin{axis}[
            ...
            view={60}{40}]
         % x^2+y^2=1
        \addplot3[mesh,500,domain=0:2,y domain=0:2*pi, samples=20]({cos(deg(y))},{sin(deg(y))},{x});    
        \addplot3[mesh,500,domain=0:2,y domain=0:2*pi, samples=20]({cos(deg(y))},{sin(deg(y))},{-x});   
    \end{axis}
\end{tikzpicture}
\end{minipage}
...
\sffamily
    \begin{axis}[
        ...
        \addplot3[mesh,500,domain=-2:2,y domain=-2:2, samples=20]({0.5*cosh(y)},{0.5*sinh(y)},{x});
        \addplot3[mesh,500,domain=-2:2,y domain=-2:2, samples=20]({-0.5*cosh(y)},{0.5*sinh(y)},{x});    
        %\addplot3[mesh,500,domain=-2:2,y domain=-2:2, samples=20]({cosh(y)},{sinh(y)},{-x});   
    \end{axis}
\end{tikzpicture}
\end{minipage}
...
\begin{tikzpicture}
  ...
  \tkzAxeXY
  \draw[scale=1,domain=-2.5:2.5,smooth,variable=\x,500, samples=20] plot ({2*sin(2*\x r)},{cos(2*\x r)});
\end{tikzpicture}
\end{minipage}
...
\begin{tikzpicture}
  ...
  \tkzInit[ymin=-2.5,ymax=2.5,xmin=-2.5,xmax=2.5]
  \tkzAxeXY
  \draw[scale=1,domain=-pi/2:pi/2,smooth,variable=\x,500, samples=20] plot ({cosh(\x)},{sinh(\x)});
\end{tikzpicture}
\end{minipage}
...
\addplot3 [surf,mesh/interior colormap=
           {inside}{color=(50) color=(300)},colormap/blackwhite,shader=flat,draw=black, samples=20] {x^2+y^2};
\end{axis}
\end{tikzpicture}
\end{minipage}
...
\begin{axis}
\addplot3 [surf,mesh/interior colormap=
           {inside}{color=(50) color=(300)},colormap/blackwhite,shader=flat,draw=black, samples=20] {x^2};
\end{axis}
\end{tikzpicture}
\end{minipage}
