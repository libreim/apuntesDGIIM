...
%Estos apuntes han sido realizados por libreim, de manera principal por los alumnos
%de la promoción del 97 del doble grado en ingieniería informática y matemáticas.
...
\end{nth}
\begin{proof}
Para los puntos medios se tienen homotecias de razón 1/2 y se dedice que $A_1B_1A_2B_2$ y $A'C'A_2C_2$ son rectánguls con lados paralelos a los lados de ABC y a sus alturas. Por tanto $$C_{B'B_2} = C _{A'A_2} = C_{C'C_2}$$.

Además  $$A_3 \vee A' = B\vee C \perp h_A = A_3\vee A_2 $$ da $A_3 \in C_{A'A_2}$ y análogamente el resto.

la circunferencia de los 9 puntos es la ircuferencia circunscrita del triángulo $A'B'C'$ y su centro es $$O' = 1/2O+1/2H$$. En el se cortan las diagonales de los rectángulos.
