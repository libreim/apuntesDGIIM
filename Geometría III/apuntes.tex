...
%%%Elegir cual os gusta más please.
...
\begin{nlist}
	...
	\item La mediatriz es una recta que viene dada por $<\vec{AB},P> = \dfrac{1}{2}(|B|^2-|A|^2)$ y que es perpendicular al segmento $AB$ y pasa por $M$ el punto medio del segmento.\\
		...
		\end{proof}
\end{nlist}
%%% Revisar estilo de la raiz cuadrada.
\begin{nota}
...
\end{proof}
%¿esto no debería ir e ejercicios?
...
\tikzpicture[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm,scale=0.4]
\draw [color=cqcqcq,, xstep=2.0cm,ystep=2.0cm] (-6.172138488994639,-1.7754832599642767) grid (11.578919976204638,9.629341867935777);
\draw[->,color=black] (-6.172138488994639,0.) -- (11.578919976204638,0.);
\foreach \x in {-6.,-4.,-2.,2.,4.,6.,8.,10.}
\draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {$\x$};
\draw[->,color=black] (0.,-1.7754832599642767) -- (0.,9.629341867935777);
\foreach \y in {,2.,4.,6.,8.}
\draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {$\y$};
\draw[color=black] (0pt,-10pt) node[right] {$0$};
\clip(-6.172138488994639,-1.7754832599642767) rectangle (11.578919976204638,9.629341867935777);
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.10000000149011612] (0.,1.) -- (2.,3.) -- (6.,3.) -- (3.,0.) -- cycle;
\draw [domain=-6.172138488994639:11.578919976204638] plot(\x,{(--6.--2.*\x)/6.});
\draw [color=zzttqq] (0.,1.)-- (2.,3.);
\draw [color=zzttqq] (2.,3.)-- (6.,3.);
\draw [color=zzttqq] (6.,3.)-- (3.,0.);
\draw [color=zzttqq] (3.,0.)-- (0.,1.);
\draw [fill=xdxdff] (0.,1.) circle (2.5pt);
\draw[color=xdxdff] (0.20475298036883344,1.5815822010708196) node {$A$};
\draw [fill=qqqqff] (6.,3.) circle (2.5pt);
\draw[color=qqqqff] (6.213746864961336,3.5743607852469044) node {$B$};
\draw[color=black] (11.211022391433673,4.555421011302823) node {$f$};
\draw [fill=qqqqff] (2.,3.) circle (2.5pt);
\draw[color=qqqqff] (2.2281896966091663,3.5743607852469044) node {$C$};
\draw [fill=qqqqff] (3.,0.) circle (2.5pt);
\draw[color=qqqqff] (3.2092499226650846,0.5698638429506537) node {$D$};
\draw[color=zzttqq] (1.431078262938732,1.9188216537775418) node {$a$};
\draw[color=zzttqq] (4.067677620464014,2.7772493515764705) node {$c$};
\draw[color=zzttqq] (4.220968280785251,2.133428578227274) node {$b$};
\draw[color=zzttqq] (1.7376595835812065,1.2443427483640979) node {$d$};
\endtikzpicture
...
\draw [color=cqcqcq,, xstep=1.0cm,ystep=1.0cm] (-4.3,-2.46) grid (7.28,6.3);
\draw[->,color=black] (-4.3,0.) -- (7.28,0.);
...
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.1] (0.68,3.5) -- (3.42,1.06) -- (3.78,4.12) -- (1.02,0.8) -- cycle;
\draw [color=zzttqq] (0.68,3.5)-- (3.42,1.06);
\draw [color=zzttqq] (3.42,1.06)-- (3.78,4.12);
\draw [color=zzttqq] (3.78,4.12)-- (1.02,0.8);
\draw [color=zzttqq] (1.02,0.8)-- (0.68,3.5);
\begin{scriptsize}
\draw [fill=qqqqff] (0.68,3.5) circle (2.5pt);
\draw[color=qqqqff] (0.82,3.86) node {$A$};
\draw [fill=qqqqff] (3.42,1.06) circle (2.5pt);
\draw[color=qqqqff] (3.56,1.42) node {$B$};
\draw [fill=qqqqff] (3.78,4.12) circle (2.5pt);
\draw[color=qqqqff] (3.92,4.48) node {$C$};
\draw [fill=qqqqff] (1.02,0.8) circle (2.5pt);
\draw[color=qqqqff] (1.16,1.16) node {$D$};
\draw[color=zzttqq] (1.88,2.22) node {$a$};
\draw[color=zzttqq] (3.96,2.72) node {$b$};
\draw[color=zzttqq] (2.2,2.84) node {$c$};
\draw[color=zzttqq] (1.22,2.36) node {$d$};
\end{scriptsize}
\end{tikzpicture}
\end{itemize}
\end{ndef}
