...
\begin{proof}\hfill \\
  ...
  %Creeis que hace falta demostrar que en un paralelogramo los ángulos son iguales 2a2
  $\boxed{\Leftarrow}$ 
  Sabemos que los ángulos de un paralelogramo tienen los ángulos iguales 2 a 2. Además sabemos que cada una de las diagonales es la hipotenusa 
