...
% Info
\title{\textbf{Análisis Matemático I}\\ Apuntes\\ \vspace{2em}\large{Doble Grado de Informática y Matemáticas}}
\author{}
...
Sea $\emptyset \ne A \subseteq \mathbb{R}^N$. Entonces: $$f\ es\ continua\ en\ a \iff \forall \{x_n\}\subseteq A\ con\ \{x_n\} \rightarrow a \Rightarrow \{f(x_n)\} \rightarrow f(a).$$
\end{nprop}
...
Sean $(X,d)$, $(Y,d)$ espacios métricos, $\emptyset \ne A \subseteq X$ y $f: A \longrightarrow Y$ continua. Entonces, $f(A)$ es compacto.
\end{nth}
