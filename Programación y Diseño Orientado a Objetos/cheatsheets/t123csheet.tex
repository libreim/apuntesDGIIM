...
\label{Polimorfismo}
(Java) Reglas de compatibilidad de tipos en OO:
\begin{itemize}
\item Entre clases (herencia): el tipo dinámico de una variable puede ser su tipo estático o una subclase.
\item Entre interfaz y clases (a través de realización): el tipo dinámico de una variable puede ser el tipo estático de la interfaz implementada.
\end{itemize}
Error en compilación: si se envía un mensaje a un objeto que no tiene ese método definido en su tipo estático.
Error en ejecución: el tipo dinámico de una variable no se corresponde con el estático.
