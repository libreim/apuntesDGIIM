...
$\diamond$ Los atributos de instancia de la clase no se heredan, cada clase tiene el suyo. Sin embargo, los métodos de clase sí se heredan. Se pueden sobreescribir, pero en realidad lo que hacemos es ocultarlos. Hay que poner el require\_relative para heredar. Si se modifica un atributo de clase, se modifica en todo el árbol de herencia.
