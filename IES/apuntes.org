...
# Los siguientes apuntes han sido redactados, revisados y modificados
# por alumnos del DGIIM en base a los originales escritos por Mario
# Román. Estos se pueden encontrar en:
# "https://github.com/M42/math/blob/master/notes.org"
# 
# Esperamos que esta versión sirva como referencia de estudio para la
# asignatura "Ingeniería, Empresa y Sociedad"
#
#
# A continuación presentamos la nota de autorización expresa del
# autor de los apuntes originales:
#
...
/Silicon Valley aprovecha recursos tecnológicos de la zona, captando
empleados de las múltiples universidades de la zona, donde este perfil
es abundante./
...
empresas se daría este caso, pues habría pocos candidatos para la
...
vender los productos, y más alta es la competencia. En ocasiones las
empresas procuran aumentar su capacidad productiva por diversos fines
(tales como conseguir economías de escala). Por esto la competencia se
escrudece.

/Un planta con capacidad de producir 1000 unidades/día debe seguir
produciendo a ese volumen, lo que puede llevar a una mayor oferta que
