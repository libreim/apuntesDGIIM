...
Primero, presentaremos otros conceptos. Comenzaremos por repasar brevemente los conceptos de relación binaria y
...
\begin{ndef}[Relación binaria]
  ...
  y se dice que ``$a$ y $b$ están relacionados mediante $\sim$''.
\end{ndef}
