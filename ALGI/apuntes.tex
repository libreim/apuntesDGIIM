...
\begin{ndef}[Anillo de polinomios en $r$ variables sobre un anillo conmutativo]
  ...
  \[
      A[x_1, \dots, x_r] = \left\{ \sum_{i=0}^n b_iX^{p_i} : 
      \begin{array}{l}
        B = \{b_0, \dots, b_n\} \subseteq A \\
        P = \{p_0, \dots, p_n\} \subset \mathbb{N}^r \\
        n \in \mathbb{N}
      \end{array} \right\}
   \]
...
\begin{proof}
  ...
  Se puede comprobar que este es un isomorfismo de anillo conmutativos.
