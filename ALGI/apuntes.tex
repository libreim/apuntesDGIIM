...
\hypersetup{
  ...
  citecolor={500!50!black},   % Color de enlaces de referencias
  urlcolor={500!80!black}     % Color de enlaces de URL
}
...
\begin{ndef}[Característica de una anillo]
  ...
  \[
     \underbrace{1 + \dots + 1 = 0}_{n \text{ sumandos}}
  \]
...
%% TODO: Demostrar que $F$ es un cuerpo sobre $\mathbb{Z}_p$, y no sobre otro cuerpo de restos de \mathbb{Z}
\begin{proof}
  Por las propiedades de $F$ como cuerpo, se puede comprobar que $F$ es un espacio vectorial sobre $\ent_{p}$ (y no sobre otro cuerpo de restos de $\ent$).
