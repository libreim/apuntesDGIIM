...
\begin{ndef}[Centro]
	Un {\itshape centro} de $\cal Q$ es un punto $A=(a,b,c)$ que es un centro de simetr\'ia de $\cal Q$, es decir, tal que la reflexi\'on central $\sigma_A:\mathbb{R}^3\longrightarrow\mathbb{R}^3$, $\sigma_A(P)= -P+2A$ lleva  $\cal Q$ en $\cal Q$. Hacemos el cambio de coordenadas que toma a $A$ como nuevo origen y
...
\subsubsection{\bfseries Ecuaci\'on reducida de una cu\'adrica con centro}
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Elipsoide imaginario}\vspace{1em}\\
  $\displaystyle -\frac{{x}^2}{a^2} - \frac{{y}^2}{b^2} - \frac{{z}^2}{c^2} = 1$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Hiperboloide de una hoja}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} + \frac{{y}^2}{b^2}-\frac{{z}^2}{c^2} = 1$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Hiperboloide de dos hojas}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} - \frac{{y}^2}{b^2}-\frac{{z}^2}{c^2} = 1$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Cono imaginario}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} + \frac{{y}^2}{b^2}+\frac{{z}^2}{c^2}=0$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Cilindro elíptico}\vspace{1em}\\
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Cilindro imaginario}\vspace{1em}\\
  $\displaystyle -\frac{{x}^2}{a^2} - \frac{{y}^2}{b^2}=1$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Cilindro hiperbólico}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} - \frac{{y}^2}{b^2}=1$
\end{minipage}\hfill
\begin{minipage}[]{0.45\textwidth}
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Par de planos reales}\vspace{1em}\\
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Par de planos imaginarios}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} + \frac{{y}^2}{b^2}=0$
\end{minipage}\hfill\vspace{1em}
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Par de planos paralelos}\vspace{1em}\\
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Par de planos imaginarios paralelos}\vspace{1em}\\
  $\displaystyle \frac{{x}^2}{a^2} =-1$
\end{minipage}\hfill\vspace{1em}
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\begin{minipage}[c]{0.45\textwidth}
  {\bfseries Plano doble}\vspace{1em}\\
  $\displaystyle {{x}^2} = 0$
\end{minipage}\hfill\vspace{1em}
\begin{minipage}[]{0.45\textwidth}
\hfill
...
\subsection{\bfseries  C\'onicas con centro en $\mathbb{R}^2$.}
...
\\
\bfseries
{\bfseries  Par de rectas reales concurrentes}  &
$
\frac{{x}^2}{a^2} - \frac{{y}^2}{b^2}=0
$
\vspace{.4cm}
\\
{\itshape Par de rectas imaginarias} &
$
\frac{{x}^2}{a^2} + \frac{{y}^2}{b^2}=0
$
\vspace{.4cm}
\\bfseries
{\bfseries  Par de rectas reales paralelas}  &
$
\frac{{x}^2}{a^2}=1
$
\vspace{.4cm}
\\
{\itshape Par de rectas imaginarias paralelas}  &
$
-\frac{{x}^2}{a^2} = 1
$
\vspace{.4cm}
\\bfseries
{\bfseries  Recta doble}  &
$
{{x}^2} = 0
$
\vspace{.3cm}
\\
\end{tabular}\bfseries
\subsubsection{\bfseries  Elementos notables de las c\'onicas y cu\'adricas con centro.}
...
\bfseries
\subsection{\bfseries Cu\'adricas sin centro en $\mathbb{R}^3$.}
...
\be\bfseries{minipage}[c]{0.45\textwidth}
  {\bfseries Paraboloide elíptico}\vspace{1em}\\
...
\be\bfseries{minipage}[c]{0.5\textwidth}
  {\bfseries Paraboloide hiperbólico}\vspace{1em}\\
  $\displaystyle z = \frac{x^2}{a^2} - \frac{y^2}{b^2}$
\end{minipage}\hfill
...
\be\bfseries{minipage}[c]{0.45\textwidth}
  {\bfseries Cilindro parabólico}\vspace{1em}\\
