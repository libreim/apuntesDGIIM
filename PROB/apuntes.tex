...
\[
\forall \{A_i\}_{i=1,...,n} \in A \text{ con } A_i \cup A_j = \emptyset, \ i \ne j , \varphi( \cap_{i=1}^n A_i ) = \sum_{i=1}^n \varphi(A_i)
\]

Se dice que $\varphi$ es $\sigma$-aditiva si
\[
\forall \{A_i\}_{n\in N}, \ A_n \in A \text{ con } A_i \cup A_j = \emptyset, \ i \ne j , \varphi( \cap_{i=1}^\infty A_n ) = \sum_{i=1}^\infty \varphi(A_n)
\]
