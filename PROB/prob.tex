...
% Estilos propios de los apuntes de Probabilidad

\surroundwithmdframed[style=nth-frame]{theorem}
\surroundwithmdframed[style=nprop-frame]{lemma}
\surroundwithmdframed[style=nprop-frame]{criterion}
